...
def sync_project_template(
    ...
    added, updated, removed = implementation_service.sync_implementation_milestones(db, implementation_id)
    return {"message": f"Synced successfully. Added {added} new, updated {updated} weights, and removed {removed} old milestones."}
